...
public class Addmovie implements ActionListener {
    ...
    // JTextField date_text1 = new JTextField();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == add_movie) {
            ...
            int success = obj.addMovie(movie_name_text.getText(), movie_description.getText(), theatre_text.getText(),
                    seats_text.getText(), date_text.getText(), day_text.getText());
            if (success == 1)
                JOptionPane.showMessageDialog(null, "Movie Added");
            else
                JOptionPane.showMessageDialog(null, "Another Movie already scheduled for that day");
        }
        if (e.getSource() == back) {
            frame.dispose();
            new ManagerView();
